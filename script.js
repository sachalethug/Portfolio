...
const projectsData = {
    ...
    8: {
        ...
        apprentissage: "Individuellement, l’objectif est de créer un site web d’application web météo avec des langages web (HTML, CSS, Javascript)",
    ...
    10: {
        title: "SAE 3.01 / 3.02 - Infrastructure Réseau",
        objectifs: ["AC 21.06","AC 22.01", "AC 22.03", "AC 22.04", "AC 22.05", "AC 22.06", "AC 23.02", "AC 23.03", "AC 23.04", "AC 23.05"],
        apprentissage: "Mise en place d’un réseau inter-site pour une entreprise fictive avec un réseau physique, une infrastructure utilisateur Linux et un service cloud pour le stockage de fichiers. Rendu de documents pour l’entreprise faisant rapport de ce qui a été fait et expliquant la mise en place.",
        sujet: "Création d’un réseau informatique avec une infrastructure réseau matériel Inter-site et mise en place de différents service utilisateurs linux et d'une solution Cloud avec notice et documents d'entreprise sur l'infrastructure installer",
        acquis: "J’ai pu mettre en place un service cloud complet nommé « Nextcloud », nécessitant une large configuration passant par différents sous-services, de la personnalisation, la liaison avec la base de données utilisateurs Linux et la gestion des données. Également, un proxy a été placé pour le chiffrement du service.",
        preuves: '<a href="Document/3.01/SAE_3.01_Exemple_Fibre.jpg" target="_blank" class="proof-link">🖼️ Installation Fibre (JPG) </a><br><a href="Document/3.01/SAE_3.01_Exemple_Reseau_Logique.jpg" target="_blank" class="proof-link">🖼️ Schéma Réseau Logique (JPG) </a><br><a href="Document/3.01/Notice_Utilisateur_Nextcloud.pdf" target="_blank" class="proof-link">📄 Notice Utilisateur Nextcloud (PDF) </a><br><a href="Document/3.01/PTI_Bravo_Service_Nextcloud_S4F2.pdf" target="_blank" class="proof-link">📄 PTI Nextcloud (Procédure Technique d’Installation) (PDF) </a><br><a href="Document/3.01/PEE_Bravo_Service_Nextcloud_S4F1.ods" target="_blank" class="proof-link">📄 PEE Nextcloud (Procédure d’Exécution et d’Essai) (PDF) </a>',
        evaluation: "Cet SAE a permis une mise en œuvre plus avancée de réseau d’entreprise avec un plus grand spectre de compétences, demandant plus de recherche et de connaissance, ce qui a tout de même posé des difficultés qui ont fini par être surmontées.",
        competences: ["Solution Cloud Storage", "Gestion Chiffrement HTTPS"],
        status: "completed"
    },

    11: {
        title: "SAE 3.03 - Réseau informatique sécurisé",
        objectifs: ["AC 21.01", "AC 21.02", "AC 21.03", "AC 21.04", "AC 21.05", "AC 21.06","AC 22.02","AC 22.03"],
        apprentissage: "En équipe de 5, à partir des besoins d’une entreprise fictive, création d’un réseau informatique avec une infrastructure réseau matérielle et d’une infrastructure service utilisateurs ;",
        sujet: "Création d'un réseau d'entreprise, sur le plan réseau et service",
        acquis: "J’ai acquis des connaissances plus techniques sur les services, principalement dans le vocabulaire et les connaissances techniques plus poussées. Cela m’a permis de concrétiser des connaissances que je n’avais pas forcément appliquées dans un cas concret comme avec la résolution DNS, le TFTP.",
        preuves: '<a href="Document/3.03/SAE_3.03-Network.jpg" target="_blank" class="proof-link">🖼️ Schéma Réseau + Plan IP (JPG) </a><br><a href="Document/3.03/SAE3.03-G3.jpg" target="_blank" class="proof-link">🖼️ Photo du matériel (JPG) </a><br><a href="Document/3.03/GROUPE3_Répartition_des_tâches.pdf" target="_blank" class="proof-link">📄 Répartition des tâches (PDF) </a><br><a href="Document/3.03/GROUPE3_schema physique_doc.pdf" target="_blank" class="proof-link">📄 Schéma Physique (PDF) </a><br><a href="Document/3.03/GROUPE3_schéma_logique_doc.pdf" target="_blank" class="proof-link">📄 Schéma Logique (PDF) </a><br><a href="Document/3.03/GROUPE3_VLAN_et_passerelles_doc.pdf" target="_blank" class="proof-link">📄 Répartition VLAN Et Gateway (PDF) </a>',
        evaluation: "Cette SAE m’a permis de revoir et de développer mes connaissances en service et également le travail d’équipe. Je n’ai pas eu l’occasion de m’exercer dans toutes les étapes du projet, principalement sur la partie matériels réseau (switch, routeur) ce qui ne semble pas incohérent étant donné la situation du projet dans lequel il était nécessaire de se répartir des taches efficacement selon nos compétences.",
        competences: ["Service Réseau", "Ogranisation de groupe"],
        status: "completed"
    },

    12: {
        title: "SAE 3.04 - Découverte du pentesting",
        objectifs: ["AC 24.01Cyber", "AC 24.05Cyber", "AC 24.06Cyber", "AC25.01Cyber", "AC25.02Cyber"],
        apprentissage: "Le service ADDS de Windows étant déployer et fonctionnel, une configuration d’utilisateurs et de groupe a été déployer, en autre la configuration du matériel réseau a été volontairement selon les critères d’évaluation peu protéger. Le but est de faire un Audit sur l’un des réseaux de nos camarades, soit une analyse du réseau pour trouver des failles et des exploits pour gagner en privilège ou modifier le comportement du réseau pour récolter des informations sur celui-ci ou bien sur les utilisateurs actifs",
        sujet: "Suite direct de la SAE 3.03, Audit sur le réseau voisin étudier ",
        acquis: "J’ai acquis des connaissances techniques sur le pentesting soit les méthodes de recherches et d’exploitation de failles sur un réseau informatique, ce qui m’a permis d’apprendre certaines pratiques à déployer sur des infrastructures qui n’ont jamais été configurées.",
        preuves: '<a href="Document/3.04/rapport_groupe3.pdf" target="_blank" class="proof-link">📄 Rapport Audit (PDF) </a>',
        evaluation: "Cette SAE a été productive et intéressante, cette situation était pour moi fondamentale, du fait qu’un réseau se doit d’être un minimum sécurisé dans son déploiement, nous avons trouvé la majorité des problèmes présents et fait un rapport en lien avec toutes les failles trouvées.",
        competences: ["Pentest", "Audit"],
        status: "completed"
    }
};
